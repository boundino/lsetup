...
(defun color-theme-boundin ()
  ...
  (color-theme-install
   '(color-theme-boundin
     ...
     (font-lock-type-face ((t (:foreground "darkseagreen3"))))
     (font-lock-variable-name-face ((t (:foreground "burlywood1"))))
     (font-lock-warning-face ((t (:foreground "thistle"))))
     (fringe ((t (:background "grey10"))))
     (header-line ((t (:box (:line-width -1 :style released-button) :foreground "antiquewhite" :background "deepskyblue4" :box nil))))
     ...
     (sh-quoted-exec ((t (:inherit font-lock-type-face))))
