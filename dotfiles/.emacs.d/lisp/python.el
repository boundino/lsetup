...
(defvar python-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    ;; (define-key map "\C-h" 'python-indent-dedent-line)
    (define-key map "\C-c<" 'python-indent-shift-left)
    ;; (define-key map "\C-h" 'python-indent-shift-left)
    ;; (define-key map "\C-c>" 'python-indent-shift-right)
    (define-key map (kbd "<backtab>") 'python-indent-shift-right)
  ...
  `(,(rx symbol-start
    ...
    (,(rx symbol-start
          (or
           ...
           ;; Mine:
           "untracked" "string" "int32" "double" "vstring" "vuint32")
